...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.zgxh.grpc.hello.HelloRequest,
      com.zgxh.grpc.hello.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.zgxh.grpc.hello.HelloRequest.class,
      responseType = com.zgxh.grpc.hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.zgxh.grpc.hello.HelloRequest,
      com.zgxh.grpc.hello.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.zgxh.grpc.hello.HelloRequest, com.zgxh.grpc.hello.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.zgxh.grpc.hello.HelloRequest, com.zgxh.grpc.hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zgxh.grpc.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zgxh.grpc.hello.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.zgxh.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.zgxh.grpc.hello.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.zgxh.grpc.hello.HelloRequest,
                com.zgxh.grpc.hello.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.zgxh.grpc.hello.HelloResponse sayHello(com.zgxh.grpc.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.zgxh.grpc.hello.HelloResponse> sayHello(
        com.zgxh.grpc.hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.zgxh.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.zgxh.grpc.hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.zgxh.grpc.hello.GrpcHello.getDescriptor();
    }
